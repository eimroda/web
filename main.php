<?php
    ...
    $_SESSION['cur_name'] = $curriculum_name;
        ...
        $(window).load(function(){
            ...
            $(function () {
                $("table#tblsubjects").on("click", ".btn-print", function () {
                    ...
                    document.getElementById("evaluation-form").action = "printpdf.php";
...
<body>
    <div class="container mt-2">
        <div class="col-md-12" >
            <form class="row g-1" method="post" name="evaluation-form" id="evaluation-form">
                <input type="hidden" name="log-out" id="log-out" value="0">
                ...
                <input type='hidden' name='course-name' id='course-name' value='$course_name'>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <label class="text-primary">School ID :</label>
                        <label class="form-control p-0"><?php echo $school_id;?></label>
                    </div>
                    <div class="col-md-3">
                        <label class="text-primary">Curriculum :</label>
                        <label class="form-control p-0"><?php echo $curriculum_name;?></label>
                    </div>
                    <div class="col-md-3">
                        <label class="text-primary">School Year :</label>
                        <?php
                            ...
                            echo "<label class='form-control p-0'>$sy_name</label>";
                        ?>
                    </div>
                    <div class="col-md-3">
                        ...
                        <?php
                            ...
                            echo "<label class='form-control p-0'>$semester_name</label>";
                        ?>
                    </div>
                </div>
                <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="button" class="btn btn-outline-primary btn-sm" id="btn-display-subjects">Display Subjects Taken</button>
                                </td>        
                                <td>
